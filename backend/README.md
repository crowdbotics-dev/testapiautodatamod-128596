...
## Project Structure
    ...
    ├── testapiautodatamod_128596  # Django project configurations
...
1. Clone this repo and `cd testapiautodatamod_128596`
...
2. Clone this repo and `cd testapiautodatamod_128596`
